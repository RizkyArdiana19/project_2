                                        ...
                                        <div class='gform_page_fields'>
                                            <ul id='gform_fields_1'
                                                ...
                                                <li id="field_1_4"
                                                    ...
                                                    <p>Tidak semua field harus diisi, jadi pastikan untuk memberikan
                                                        jawaban yang tepat sesuai dengan pengalamanmu.</p>
                                                </li>
                                                <li id="field_1_38"
                                                ...
                                                <div class='gform_page_footer top_label'>
                                                    <button type="submit"
                                                        class='gform_next_button button' id='gform_next_button_1_17' class='gform_next_button button'
                                                        value=''
                                                        onclick='jQuery("#gform_target_page_number_1").val("2");  jQuery("#gform_1").trigger("submit",[true]); '
                                                        onkeypress='if( event.keyCode == 13 ){ jQuery("#gform_target_page_number_1").val("2");  jQuery("#gform_1").trigger("submit",[true]); } '>Submit</button>
                                                </div>
