        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-layout-text-window-reverse"></i><span>Kelola Analisis</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="/hasilanalisis">
                            <i class="bi bi-circle"></i><span>Data Analisis</span>
                        </a>
                    </li>
                </ul>
            </li><!-- End Tables Nav -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/depresi">
